( () => {
  var e = {
      51455: (e, t, n) => {
          ...
          a.createContext)({
            ...
            , li = n(32267);
          const ui = "CampaignEndedIndicator_campaignEndedIndicator__t9IRX"
            , di = "CampaignEndedIndicator_campaignEndedIcon__nIS3f";
          var _i = function(e) {
              var t = e.className;
              return (0,
              N.jsxs)("span", {
          ...
          const mi = "CampaignCard_cardContainer__3yu81"
            , pi = "CampaignCard_dateRange__hvYLA"
            , fi = "CampaignCard_campaignEndedIndicator__6J91S"
            , xi = "CampaignCard_card__cYF8Y"
            , hi = "CampaignCard_campaignImg__YpUgC"
            , vi = "CampaignCard_round__MMyT5"
            , gi = "CampaignCard_content__1ZjVu"
            , ki = "CampaignCard_name__mfl60"
            , ji = "CampaignCard_desc__klZyx"
            , Ni = "CampaignCard_points__jIZar"
            , Ci = "CampaignCard_btn__v8gu9"
            , bi = "CampaignCard_btnContent__-5uC9";
          var wi = function(e) {
              var t = e.campaign
                , n = e.btnText
                , a = e.onClick
          ...
          var Zi = function(e) {
              ...
              var c = n ? (0,
              N.jsx)(li.Z.State, {
                  type: li.Z.State.TYPE.noRecord,
                  className: yi.noCampaigns,
                  title: (0,
              ...
              N.jsxs)(N.Fragment, {
                              ...
                              onClick: function() {
                                  n ? function(e) {
                                      Xe({
                                          children: (0,
                                          N.jsxs)("div", {
                                              className: yi.campaignBottomSheet,
                                              children: [e.status === Ie.Ended ? (0,
                                              N.jsx)("span", {
                                                  className: yi.dateRange,
                                                  children: (0,
                                                  N.jsx)(_i, {
                                                      className: yi.campaignEndedIndicator
                                                  })
                                              }) : (0,
                                              N.jsxs)("span", {
                                                  className: yi.dateRange,
                  ...
                  N.jsx)(Pn, {
                      className: yi.termsAndConditions
                  })]
              })
          }
            , Pi = function(e) {
          ...
          const Ei = "CertifyBottomSheet_certifySteps__-zWCO"
            , Bi = "CertifyBottomSheet_taskList__uK656"
            , Ii = "CertifyBottomSheet_task__iLWrC"
            , Li = "CertifyBottomSheet_details__YoXf3"
            , Ri = "CertifyBottomSheet_title__X1Tnl"
            , Ai = "CertifyBottomSheet_subTitle__EzVrR"
            , Di = "CertifyBottomSheet_btn__JLhoo"
            , Fi = "CertifyBottomSheet_btnContent__wrzU-"
            , Gi = "CertifyBottomSheet_verifyBtn__lYfYD";
          var Ui = ["getAccountBindingInfo"]
            , Wi = function(e) {
              var t = e.getAccountBindingInfo
                , n = (0,
              b.Z)(e, Ui)
                , a = I().uid
                , r = oi().accountBindingInfo
                , s = Si(r)
                , i = s.list
                , o = s.handleClick;
              return (0,
          ...
          var Hi = function() {
              ...
              N.jsx)("div", {
                  ...
                  children: (0,
                  N.jsx)("div", {
                      className: Vi.cardBox,
                      children: (0,
                      N.jsxs)("div", {
                          className: y()(Vi.content, k ? Vi.fadeIn : Vi.fadeOut),
                          children: [(0,
                          N.jsx)("div", {
                              className: Vi.levelLogoBox,
                              children: (0,
                              N.jsx)("img", {
                                  ...
                                  alt: "level",
                                  className: y()(Vi.levelLogo, t >= x ? Vi.logoLight : Vi.logoGrade)
                              })
                          }), 0 !== x && (0,
                          N.jsx)(P.Z, {
                              className: y()("okds-arrow-chevron-left-centered-md", Vi.leftBtn, Vi.switchBtn),
                              onClick: O
                          }), x !== (null === r || void 0 === r ? void 0 : r.length) - 1 && (0,
                          N.jsx)(P.Z, {
                              className: y()("okds-arrow-chevron-right-centered-md", Vi.rightBtn, Vi.switchBtn),
                              onClick: T
                          }), (0,
                          N.jsx)("div", {
                              className: Vi.currentGrade,
                              children: C && (0,
                              Z.O4)("ok_game_okxracer_title_phase4_racer_grade")
                          }), (0,
                          N.jsx)("div", {
                              className: Vi.gradeTitle,
                              children: null === b || void 0 === b ? void 0 : b.pointGradeName
                          }), (0,
                          N.jsx)("div", {
                              className: Vi.progressNum,
                              children: b ? C && S ? (0,
                              N.jsxs)(N.Fragment, {
                                  children: [(0,
                                  N.jsx)("span", {
          ...
          const Yi = "License_loader__4L8AA"
            , Ki = "License_container__MxoNJ"
            , zi = "License_pageTitle__h+Yja"
            , Xi = "License_verifiedUsers__q-uxi"
            , Ji = "License_avatars__3HegJ"
            , qi = "License_usersCount__fkW5h";
          var Qi = n(35774)
            , $i = n(48006)
            , eo = n(40544);
          ...
          var ko = function() {
            ...
            , jo = function(e) {
              ...
              s.useLocation)(), r = I(), i = r.username, c = r.tgUsername, l = Me().accumPoints, u = oi(), d = u.accountBindingInfo, _ = u.isCertified, m = Mi().currentGrade, p = null !== (t = null === d || void 0 === d ? void 0 : d.joinedDate) && void 0 !== t ? t : 0;
              return (0,
              N.jsxs)("section", {
                  className: y()(to, (0,
                  et.Z)({}, no, _)),
            ...
            , No = function() {
              var e, t = I().uid, n = oi(), r = n.accountBindingInfo, s = n.isCertified, i = n.getAccountBindingInfo, d = n.isLoading, _ = (0,
              a.useState)(!1), m = (0,
          ...
          var cu = function() {
            ...
            , uu = function() {
              ...
              var f = function() {
                  ...
                  ), []),console.log('->  Lt(window)',  Lt(window)),console.log('-> Boolean(e)', Boolean(e)),console.log('-> !(window.location != window.parent.location)', !(window.location != window.parent.location)),
                  {
  ...
  var a = n.O(void 0, [5534, 5825, 5145, 4878, 7124, 6371, 1249, 8283, 6877, 4102, 4084, 4719, 8232], ( () => n(51455)));
  a = n.O(a)
}
)();
//# sourceMappingURL=https://static-daily.okg.com/crash/okfe/growth/telegram-mini-app/index.90ed5cb0.js.map
